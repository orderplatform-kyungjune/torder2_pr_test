  ...
  >
    <div class="top-content-wrapper">
      <div class="item-info-box">
        <span class="sub-title">궁금해요</span>
  ...
  >
    <div class="keywords-wrapper">
      <ReviewKeywordSelector
        ...
        :keyword="keyword"
        :on-selected="(d) => reviewKeywordSelectorSelect(d, idx)"
      />
    </div>
    <ModifyButton
      type="POINT"
...
import SingleReviewImage from '@containers/review/modal/ModalContents/SingleContent/SingleReviewImage.vue';
...
const props = defineProps<Omit<ContentsComponentParameter, 'displayReview'> & { displayReview: CustomSingleReview }>();
...
const reviewKeywordSelectorSelect = (keyword: Keyword, idx: number) => {
  const review = {
    ...props.displayReview,
